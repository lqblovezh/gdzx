          ...
          res => {
            ...
            for (let key in warehouse) {
              ...
              if (items) {
                ...
                items.status = warehouse[key].access_status
              }
            }
            ...
            for (let key in product) {
              ...
              if (items) {
                ...
                items.status = product[key].access_status
              }
            }
      ...
      .warehouse.modular(v-if='warehouse')
        ...
        ul.list
          li(v-for="item in warehouse" :class="item.icon")
            router-link(:to="'/contentLibrary/'+item.path" v-if="item.status")
              p {{item.name}}
      ...
      .product.modular(v-if='product')
        ...
        ul.list
          li(v-for="item in product" :class="item.icon")
            router-link.body(:to="'/digitalProductLibrary/'+item.path" v-if="item.status")
              .left
              .body
                p {{item.name}}
                p {{item.count|formatNum}}
