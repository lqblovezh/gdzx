...
import Detail from '../audio/detail'
import status from '@/util/status'

import {
  main
} from '@/util/mixins'
import * as services from "services/x-publish/courseware/video"
...
.index.clearfix
	...
	Menu(curr="/digitalProductLibrary/media")
	.mainRight
		.contentWrap
			.contentLeft
				.maindata
					.serachWrap
						...
						form#mainForm.clearfix
							span.group-inline
								el-input(placeholder="课件名称" name="name" clearable v-model="searchQuery.name")
							span.group-inline
