								...
								tr(v-for="item in list")
									...
									th
										.btns
											...
											Icon(type="icon-upload" v-if="item.status=='0'&&item.set=='1'" title="上架" @click="upShelf(item.id)")
											Icon(type="el-icon-setting" v-if="item.status=='0'&&item.set=='1'" title="栏目设置" @click="showUpShelf(item)")
