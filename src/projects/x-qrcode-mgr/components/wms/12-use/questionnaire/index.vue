...
import * as service from 'services/x-qrcode/vote/questionnaire'
						...
						table.table
							...
							tbody(v-if="tableData")
								tr(v-for="item in tableData")
									...
									th
										.btns
											//- Icon(type="icon-detail" title="详情" @click="opneDetailDialog(item.id)")
											span(type="icon-detail" title="详情" @click="opneDetailDialog(item.id)") 详情&nbsp;&nbsp;
											//- Icon(type="icon-preview" title="报表" @click="$router.push({path:'/wms/voteInfo',query:{pn:page.pageNum,id:item.id}})")
											span(type="icon-preview" title="报表" @click="$router.push({path:'/wms/voteInfo',query:{pn:page.pageNum,id:item.id}})") 报表&nbsp;&nbsp;
