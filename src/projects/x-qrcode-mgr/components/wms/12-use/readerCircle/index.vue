					...
					.serachWrap
						...
						form#mainForm.clearfix
							...
							span.group-inline.float-right
								el-button(size="mediu" type="primary"   icon="el-icon-search"  @click="searchLimit" plain ) 搜索
					.tableWrap
						.tableTop
							.title.vel-line
								span 全部 <span v-if="page" class="totalNum">({{total}})</span>
								.btns
								...
								tr(v-for="item in tableData")
									...
									th
										.btns
											...
											span(type="icon-delete" title="删除" @click="del(item.id)") 删除
						//- 分页
						.pageWrap(v-if="page")
							el-pagination(
